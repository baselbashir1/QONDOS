            ...
            <div class="widget-content widget-content-area ecommerce-create-section">
                <div class="row mb-4">
                    <div class="col-sm-12">
                        ...
                        <div class="form-control" style="pointer-events: none">{{ $specialOrderOffer->client->name }}
                        </div>
                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col-sm-12">
                        ...
                        <div class="form-control" style="pointer-events: none">
                            {{ $specialOrderOffer->maintenanceTechnician->name }}
                        </div>
                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col-sm-12">
                        ...
                        <div class="form-control" style="pointer-events: none">
                            {{ $specialOrderOffer->maintenanceTechnician->ratings->avg('rate') }}</div>
                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col-sm-12">
                ...
                <div class="row mb-4">
                    <div class="col-sm-12">
                        ...
                        <textarea class="form-control" style="pointer-events: none">{{ $specialOrderOffer->description }}</textarea>
                    </div>
                </div>
            </div>
        </div>
